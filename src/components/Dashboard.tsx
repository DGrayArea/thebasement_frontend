  ...
  return (
    <div className="py-10">
      ...
      >
        ...
        >
          <span className="bg-clip-text text-transparent bg-gradient-to-r from-solana to-solana-secondary">
        ...
        <motion.h1
          ...
          className="text-4xl sm:text-5xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-white to-white/70"
        >
        ...
        >
          <div className="glass rounded-2xl p-6">
            <div className="flex items-start justify-between">
              <div>
                <div className="text-sm opacity-60 mb-1">Your Deposits</div>
                <div className="text-3xl font-bold">$0.00</div>
              </div>
              <div className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center">
                <Gem className="w-5 h-5 text-ibf" />
              </div>
            </div>
          </div>
          ...
          <div className="glass rounded-2xl p-6">
            <div className="flex items-start justify-between">
              <div>
                <div className="text-sm opacity-60 mb-1">Earned Yield</div>
                <div className="text-3xl font-bold">$0.00</div>
              </div>
              <div className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center">
                <TrendingUp className="w-5 h-5 text-ibf" />
              </div>
            </div>
          </div>
          ...
          <div className="glass rounded-2xl p-6">
            <div className="flex items-start justify-between">
              <div>
                <div className="text-sm opacity-60 mb-1">Transactions</div>
                <div className="text-3xl font-bold">0</div>
              </div>
              <div className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center">
                <History className="w-5 h-5 text-ibf" />
              </div>
            </div>
          </div>
        </motion.div>
      ...
      <div className="mb-16">
        ...
        >
          ...
          <div className="text-sm opacity-60">2 pools</div>
        </motion.div>
